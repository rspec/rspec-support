    ...
    describe 'verifying methods' do
      ...
      describe StrictSignatureVerifier do
        ...
        if RubyFeatures.kw_args_supported?
          ...
          it 'does not allow a matcher in place of optional keyword arguments' do
        ...
        if RubyFeatures.required_kw_args_supported?
          ...
          it 'does not allow a matcher in place of keyword arguments' do
            expect(valid?(nil, fake_matcher)).to eq(false)
          end
        end
      end
      ...
      describe LooseSignatureVerifier do
        ...
        if RubyFeatures.kw_args_supported?
          ...
          it 'allows a matcher to be provided in place of kw arguments' do
        ...
        if RubyFeatures.required_kw_args_supported?
          ...
          it 'allows a matcher in place of keyword arguments' do
            expect(valid?(nil, fake_matcher)).to eq(true)
          end
        end
      end
